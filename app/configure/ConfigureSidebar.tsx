    ...
    <div className="p-4 space-y-6">
      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          <Link
            href="/configure/snippets"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/snippets')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            ...
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/integrations')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/documentation"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/documentation')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/data-loader"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/data-loader')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/data-stores"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/data-stores')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/csv-loader"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/csv-loader')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/connections"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/connections')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
          ...
          <Link
            href="/configure/tasks"
            className={`block px-3 py-2 text-sm rounded-md transition-colors ${
              isActive('/configure/tasks')
                ? 'bg-red-50 dark:bg-red-950 text-red-600 dark:text-red-400 font-medium'
                : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'
            }`}
          >
